            ...
            child: GridView.builder(
                ...
                itemBuilder: (context, index) {
                  return GestureDetector(
                    onTap: () {
                      // print('___________________${productsAndService[index]}');
                      pos.addProductToCart(productsAndService[index]);
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          productsAndService[index].image!=null?Expanded(
                            child: Container(
                              decoration: BoxDecoration(
                                image: DecorationImage(image: NetworkImage(productsAndService[index].image!))
                              ),
                              padding:
                          ...
                          productsAndService[index].image==null?Container(
                            ...
                            decoration: const BoxDecoration(
                                ...
                                BorderRadius.all(
                                    Radius.circular(
                                        6))),
                            child: Text(
                              '\$ ${productsAndService[index].price}',
                              style: mainSubHeadingStyle()
                                  .copyWith(
                                  color: AppColors
